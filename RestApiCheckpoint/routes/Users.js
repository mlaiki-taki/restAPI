...
// @Method: POST
// @PATH: http://localhost:3001/api/users/add_user
...
router.get("/users_list", controllers.getusers);

// @DESC: REMOVE A USER BY ID
// @Method: DELETE
// @PATH: http://localhost:3001/api/users/delete_user/:id
// Params : id
...
// @Method: PUT
// PATH: http://localhost:3001/api/users/edit_user/:id
// Params : id
// DATA: req.body
